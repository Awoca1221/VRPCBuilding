...
public class HeadCollisionDetector : MonoBehaviour
{
    ...
    (Vector3 position, float distance, LayerMask mask)
    {
        ...
        List<Vector3> directions
            = new() { transform.forward, -transform.forward, transform.right, -transform.right };
    ...
    private void OnDrawGizmos()
    {
        ...
        List<Vector3> directions = new() { transform.forward, -transform.forward, transform.right, -transform.right };
