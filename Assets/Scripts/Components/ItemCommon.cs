...
public class CPUInfo : BaseInfo
{
    ...
    public uint TDP { get; } = 0;
    public CPUInfo(string a, CPUManufacturer b, string c, CPUSocketType d, uint e, uint f)
    {
        Name = a;
        CPUManufacturer = b;
        Model = c;
...
public class GPUInfo : BaseInfo
{
    ...
    public uint Performance { get; } = 0;
    public uint TDP { get; } = 0;
    public GPUInfo(string a, GPUManufacturer b, string c, uint d, PCIEType e, uint f, uint g)
    {
        Name = a;
        GPUManufacturer = b;
        Model = c;
...
public class RAMInfo : BaseInfo
{
    ...
    public uint MemoryAmountGB { get; } = 0;
    public uint FrequencyMhz { get; } = 0;
    public RAMInfo(string a, MemoryType b, uint c, uint d)
    {
        Name = a;
        DDRType = b;
        MemoryAmountGB = c;
...
public class ItemCommon : MonoBehaviour
{
    ...
    {
        CPUInfo data = new(Name, CPUManufacturer, Model, SocketType, Performance, TDP);
        return data;
    }
    public GPUInfo GetGPUInfo()
    {
        GPUInfo data = new(Name, GPUManufacturer, Model, MemoryAmountGB, PCIESupport, Performance, TDP);
        return data;
    }
    public RAMInfo GetRAMInfo()
    {
        RAMInfo data = new(Name, DDRType, MemoryAmountGB, FrequencyMhz);
        return data;
    }
